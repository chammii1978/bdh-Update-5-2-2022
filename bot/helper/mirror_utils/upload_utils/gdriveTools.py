        ...
        try:
            ...
            if mime_type == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                if mime_type is None:
                    mime_type = 'File'
                msg += f'\n\n<b>╔● ফাইল সাইজ: </b>{get_readable_file_size(int(meta.get("size", 0)))}'
                msg += f'\n\n<b>╚● ফাইলের ধরন: </b>{mime_type}'
                if INDEX_URL is not None:
    ...
    def count(self, link):
        ...
        try:
            ...
            if mime_type == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                msg += f'\n<b>╔● সাইজ: </b>{get_readable_file_size(self.total_bytes)}'
                msg += '\n<b>╟● ধরন: </b>Folder'
                msg += f'\n<b>╟● সাব-ফোল্ডার সংখ্যা: </b>{self.total_folders}'
                msg += f'\n<b>╟● ফাইল সংখ্যা: </b>{self.total_files}'
            else:
                msg += f'<b>📂● ফাইলের নাম: </b><code>{name}</code>'
                if mime_type is None:
                    mime_type = 'File'
